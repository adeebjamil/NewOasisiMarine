...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: `${productName} | Oasis Marine Trading LLC`,
    description:
      product?.shortDescription || `Discover ${productName} from Oasis Marine Trading LLC. High-quality marine and industrial solutions in UAE.`,
    keywords:
      `${productName}, marine equipment, industrial supplies, Oasis Marine, UAE`,
    openGraph: {
      title: `${productName} | Oasis Marine Trading LLC`,
      description:
        product?.shortDescription || `Discover ${productName} from Oasis Marine Trading LLC. High-quality marine and industrial solutions.`,
      type: 'website',
